...
* ** FoFa语句 **
product="碧海威科技-L7云路由" || title="碧海威L7"


* ** 推荐语句 **
*
* URL批量检测并保存：
python POC_碧海威L7前台弱口令.py -f url.txt -u user.txt -p pass.txt -o result.txt 

* 单个URL检测：
python POC_碧海威L7前台弱口令.py -t url -u user.txt -p pass.txt
