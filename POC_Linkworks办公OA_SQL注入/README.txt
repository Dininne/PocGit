...
* ** FoFa语句 **
"/Services/Identification/Server/" || fid="/yV4r5PdARKT4jaqLjJYqw=="


* ** 推荐语句 **
*
* URL批量检测并保存：
python POC_Linkworks办公OA_SQL注入.py -f url.txt -o result.txt

* 单个URL检测：
python POC_Linkworks办公OA_SQL注入.py -t url
